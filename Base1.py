...
cursor.execute("INSERT INTO animal VALUES(1,'casa,' Cat','Gris','M','gato')")

cursor.execute("INSERT INTO animal VALUES(2,'casa','polito','Gris','M','gato')")
cursor.execute("INSERT INTO animal VALUES(3,'casa','Espinocito','Café','M','Erizo')")
